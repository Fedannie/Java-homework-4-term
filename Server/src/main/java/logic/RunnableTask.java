...
class RunnableTask implements Runnable {
    ...
    private Path path;
    /**logic.Client which hash sent this task to server.*/
    private Socket client;

    /**
     * Constructs new {@code logic.RunnableTask} object by a path to root directory and a clientSocket.
